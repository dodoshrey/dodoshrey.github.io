...
const Experience = () => {
  ...
  return (
    <section id="experience" className="min-h-[100vh] py-20 bg-blue-950 dark:bg-gray-950 flex items-center justify-center">
        ...
        <div className="space-y-8">
          {experiences.map((exp, index) => (
            <div key={index} className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-6">
                ...
                {/* View Details Button */}
                <button
                  className="mt-4 md:mt-0 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-semibold transition-colors"
          ...
          {openModalIndex !== null && (
            <Modal open={true} onClose={() => setOpenModalIndex(null)}>
              <div className="p-6">
                <h3 className="text-2xl font-bold mb-2 text-gray-900 dark:text-white">{experiences[openModalIndex].title}</h3>
                <p className="text-xl text-blue-600 dark:text-blue-400 font-semibold mb-2">{experiences[openModalIndex].company}</p>
                <div className="flex items-center text-gray-600 dark:text-gray-300 mb-4">
                  <Calendar className="w-4 h-4 mr-2" />
                  <span>{experiences[openModalIndex].period} • {experiences[openModalIndex].location}</span>
                </div>
                <p className="text-gray-700 dark:text-gray-200 text-lg mb-4">{experiences[openModalIndex].description}</p>
                <div className="mb-4">
                ...
                {experiences[openModalIndex].projects && (
                  <div className="mb-4">
                    <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Projects:</h4>
