    ...
    <section id="about" className="min-h-[100vh] py-20 bg-blue-950 dark:bg-gray-950 flex items-center justify-center">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl font-serif md:text-5xl font-bold text-purple-500 dark:text-orange-400 mb-6">
            About Me
          </h2>

          <p className="text-xl font-serif text-orange-400 dark:text-purple-500 leading-relaxed">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <img 
              ...
              className="rounded-lg w-full max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl h-auto mx-auto"
            />
          </div>
          
          <div className="space-y-6">

            <p className="text-lg font-mono text-orange-400 dark:text-purple-500 leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-8">
              <div className="text-center p-6 bg-blue-50 dark:bg-blue-900 rounded-lg">
                ...
                <h3 className="font-sans text-gray-900 dark:text-white">Clean Code</h3>
                <p className="font-mono text-sm text-gray-600 dark:text-gray-300 mt-2">Writing maintainable, scalable solutions</p>
              </div>
              ...
              <div className="text-center p-6 bg-purple-50 dark:bg-purple-900 rounded-lg">
                ...
                <h3 className="font-sans text-gray-900 dark:text-white">Collaboration</h3>
                <p className="font-mono text-sm text-gray-600 dark:text-gray-300 mt-2">Working seamlessly across teams</p>
              </div>
              ...
              <div className="text-center p-6 bg-green-50 dark:bg-green-900 rounded-lg">
                ...
                <h3 className="font-sans text-gray-900 dark:text-white">Performance</h3>
                <p className="font-mono text-sm text-gray-600 dark:text-gray-300 mt-2">Optimizing for speed and efficiency</p>
              </div>
            </div>
